            ...
            <SidebarContext.Provider value={contextValue}>
                <TooltipProvider delayDuration={0}>
                    <div
                        ...
                        className={cn(
                            "group/sidebar-wrapper text-sidebar-foreground flex min-h-svh w-full has-[[data-variant=inset]]:bg-background",
                            className
                        )}
                        ref={ref}
                        {...props}
            ...
            >
                ...
                >
                    <div
                        data-sidebar="sidebar"
                        className={cn(
                            "bg-sidebar group-data-[variant=floating]:border-sidebar-border group-data-[variant=primary]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=primary]:rounded-r-lg group-data-[variant=floating]:border group-data-[variant=primary]:border group-data-[variant=primary]:border-l-0 group-data-[variant=floating]:shadow group-data-[variant=primary]:shadow",
...
const SidebarTrigger = React.forwardRef<
    ...
    React.ComponentProps<typeof Button> & {
        icon?: React.ReactNode; // Add this new prop
        size?: "icon" | "default";
        children?: React.ReactNode;
    }
>(({ className, onClick, icon, size, children, ...props }, ref) => {
...
>(({ className, ...props }, ref) => {
    return (
        <Input
            ...
            data-sidebar="input"
            className={cn(
                "bg-sidebar-accent focus-visible:ring-sidebar-ring h-8 w-full shadow-none focus-visible:ring-0",
                className
            )}
            {...props}
        />
...
>(({ asChild = false, size = "md", isActive, className, ...props }, ref) => {
    ...
    return (
        <Comp
            ...
            data-active={isActive}
            className={cn(
                "[&>svg]:text-sidebar-muted-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground active:bg-sidebar-accent active:text-sidebar-accent-foreground flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-2 text-muted-foreground outline-none focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
