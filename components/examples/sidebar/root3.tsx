...
import { DashboardSidebar5 } from "./examples/sidebar5";
import { DashboardSidebar6 } from "./examples/sidebar6";

export function RootLayoutClient3() {
        ...
        <div className="flex h-full w-full flex-col overflow-hidden rounded-lg bg-muted">
            <div className="flex flex-1 overflow-hidden">
                <DashboardSidebar5
                    ...
                    name="left-sidebar-sidebar5"
                    secondSidebarCollapsed={left2SidebarCollapsed}
                    onSecondSidebarCollapse={setLeft2SidebarCollapsed}
                />

                <main className="relative flex-1 overflow-auto bg-muted">
                    <div className="sticky top-0 border-b bg-sidebar">
                                    ...
                                    {Array.from({ length: 15 }).map((_, i) => (
                                        ...
                                        >
                                            ...
                                            <p className="mt-2 text-muted-foreground">
                                                This is an example activity card
                                                to demonstrate scrolling
                                                content. Each card represents a
